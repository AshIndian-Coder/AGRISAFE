...
public class DemoDataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        String farmerUuid = createUser("farmer@demo.agrisafe.in", "Ramesh Farmer", null, UserType.FARMER, "ROLE_FARMER", "9988770011");
        String agentUuid = createUser("agent@demo.agrisafe.in", "Suresh Agent", null, UserType.COLLECTING_AGENT, "ROLE_COLLECTING_AGENT", "9988770022");
        String supplierUuid = createUser("supplier@demo.agrisafe.in", "Amar Supplier", null, UserType.SUPPLIER, "ROLE_SUPPLIER", "9988770033");
        String mfgUuid = createUser("manufacturer@demo.agrisafe.in", "Rohit Mfg", null, UserType.MANUFACTURER_EMPLOYEE, "ROLE_MANUFACTURER_EMPLOYEE", "9988770044");
        String distUuid = createUser("distributor@demo.agrisafe.in", "Prakash Dist", null, UserType.DISTRIBUTOR_EMPLOYEE, "ROLE_DISTRIBUTOR_EMPLOYEE", "9988770055");
        String retUuid = createUser("retailer@demo.agrisafe.in", "Amit Retail", null, UserType.RETAILER, "ROLE_RETAILER", "9988770066");
        String govtUuid = createUser("government@demo.agrisafe.in", "Vikram Govt", null, UserType.GOVERNMENT_EMPLOYEE, "ROLE_GOVERNMENT_EMPLOYEE", "9988770077");
        ...
        log.info("Farmer: farmer@demo.agrisafe.in");
        log.info("Agent: agent@demo.agrisafe.in");
        log.info("Supplier: supplier@demo.agrisafe.in");
        log.info("Manufacturer: manufacturer@demo.agrisafe.in");
        log.info("Distributor: distributor@demo.agrisafe.in");
        log.info("Retailer: retailer@demo.agrisafe.in");
        log.info("Government: government@demo.agrisafe.in");
        log.info("Lots: {} (Milk, processed), {} (Rice, manufactured), {} (Wheat, flagged)", lot1Id, lot2Id, lot3Id);
    }

    private String createUser(String email, String name, String pfRef, UserType type, String roleName, String mobile) {
